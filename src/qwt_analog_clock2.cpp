 ...
 */
QwtAnalogClock2::QwtAnalogClock2( QWidget* parent )
    : QwtDial( parent )
{
    setWrapping( true );
    setReadOnly( true );
...
//! Destructor
QwtAnalogClock2::~QwtAnalogClock2()
{
    for ( int i = 0; i < NHands; i++ )
        delete m_hand[i];
}
...
/*!
   ...
   \sa setHand()
 */
void QwtAnalogClock2::setNeedle( QwtDialNeedle* )
{
    // no op
    return;
}
...
/*!
   ...
   \sa hand()
 */
void QwtAnalogClock2::setHand( Hand hand, QwtDialNeedle* needle )
{
...
/*!
   ...
   \sa setHand()
 */
QwtDialNeedle* QwtAnalogClock2::hand( Hand hd )
{
    if ( hd < 0 || hd >= NHands )
        return NULL;
...
/*!
   ...
   \sa setHand()
 */
const QwtDialNeedle* QwtAnalogClock2::hand( Hand hd ) const
{
    return const_cast< QwtAnalogClock2* >( this )->hand( hd );
}

/*!
   \brief Set the current time
 */
void QwtAnalogClock2::setCurrentTime()
{
 ...
 */
void QwtAnalogClock2::setTime( const QTime& time )
{
    if ( time.isValid() )
    {
...
/*!
   ...
   \sa drawHand()
 */
void QwtAnalogClock2::drawNeedle( QPainter* painter, const QPointF& center,
...
/*!
   ...
   \param cg ColorGroup
 */
void QwtAnalogClock2::drawHand( QPainter* painter, Hand hd,
